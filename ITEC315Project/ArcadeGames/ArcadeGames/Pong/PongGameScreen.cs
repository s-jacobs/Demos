...
namespace ArcadeGames {
    public partial class PongGameScreen : Form {
        ...
        private void pongTimer_Tick(object sender, EventArgs e) {
            ...
            //move paddles
            if(p1DetectUp == true && paddle1.Top > topBoundary) {
                paddle1.Top -= 10;
            }
            if(p1DetectDown == true && paddle1.Top < bottomBoundaryPaddles) {
                paddle1.Top += 10;
            }

            if (p2DetectUp == true && paddle2.Top > topBoundary) {
                paddle2.Top -= 10;
            }
            if (p2DetectDown == true && paddle2.Top < bottomBoundaryPaddles) {
                paddle2.Top += 10;
            }
